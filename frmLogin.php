                    ...
                    <div class="col-md-8">
                        <div class="product-content-right">
                            <div class="woocommerce">
                                ...
                                <div class="woocommerce-info">Não possui cadastro ainda? <a class="showlogin" data-toggle="collapse" href="#cadastro-form-wrap" aria-expanded="false" aria-controls="login-form-wrap">Clique aqui para realizar o seu cadastro !</a>
                                </div>
                                
                                <form id="cadastro-form-wrap" class="login collapse" method="post">
                                            ...
                                            <div class="col-1">
                                                <div class="woocommerce-billing-fields">
                                                    ...
                                                    <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                        ...
                                                        <input type="text" value="" placeholder="Digite seu primeiro nome" id="billing_first_name" name="billing_first_name" class="input-text " required>
                                                    </p>
                                                    ...
                                                    <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                        ...
                                                        <input type="text" value="" placeholder="Digite seu ultimo nome" id="billing_last_name" name="billing_last_name" class="input-text " required>
                                                    </p>
                                                    ...
                                                    <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                        ...
                                                        <input type="text" value="" placeholder="Digite seu endereço" id="billing_address_1" name="billing_address_1" class="input-text " required>
                                                    </p>
                                                    ...
                                                    <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                                        ...
                                                        <input type="text" value="" placeholder="Apartamento, fundo, casa, etc." id="billing_address_2" name="billing_address_2" class="input-text ">
                                                    </p>
                                                    ...
                                                    <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                        ...
                                                        <input type="text" value="" placeholder="Digite nome da sua cidade" id="billing_city" name="billing_city" class="input-text " required>
                                                    </p>
                                                    ...
                                                    <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                        ...
                                                        <input type="text" id="billing_state" name="billing_state" placeholder="Digite o estado. Ex: 'São Paulo'" value="" class="input-text " required>
                                                    </p>
                                                    ...
                                                    <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                        ...
                                                        <input type="text" value="" placeholder="Digite o CEP da sua cidade" id="billing_postcode" name="billing_postcode" class="input-text " required>
                                                    </p>
                                                    ...
                                                    <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                        ...
                                                        <input type="text" value="" placeholder="Digite seu telefone. Ex: (16)91111-2222 " id="billing_phone" name="billing_phone" class="input-text " required>
                                                    </p>
                                                    <div class="clear"></div>
                                                    ...
                                                    <div class="create-account">
                                                        <p id="senha" class="form-row validate-required">
                                                            ...
                                                            <input type="password" value="" placeholder="Digite sua senha" id="senha" name="account_password" class="input-text" required>
                                                        </p>
                                                       ...
                                                       <p id="confSenha" class="form-row validate-required">
                                                            ...
                                                            <input type="password" value="" placeholder="Confirmação de senha" id="confSenha" name="account_password" class="input-text" required>
                                                        </p>                                                    
                                                        <div class="clear"></div>
