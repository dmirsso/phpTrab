...
<html lang="pt-br">
	...
	<body>  
		...
		<?php
			$descricao = $_POST['billing_nome_produto'];
			$qtde_estoque = $_POST['billing_qtde'];
			...
			try {
				...
				$sql = "INSERT INTO PRODUTO ( DESCRICAO_PROD, QTDE_ESTOQUE_PROD)
						VALUES ('$descricao', $qtde_estoque)";
