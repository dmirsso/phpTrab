...
<html lang="pt-br">
	...
	<body>  
		...
		<?php
			$texto_anu = $_POST['billing_text'];
			$valor_anu = $_POST['billing_valor_anuncio'];
			$img_anu = $_POST['billing_imagem'];
			$data_inicio_anu = $_POST['billing_inicio'];
			$data_fim_anu = $_POST['billing_fim'];
			$qtde_min_anu = $_POST['billing_qtde_min'];
			$qtde_max_anu = $_POST['billing_qtde_max'];
			$fornecedor_anu = '1';
			$produto_anu = '2';
